...
if ( ! function_exists('understrap_slbd_count_widgets')) {
    ...
    function understrap_slbd_count_widgets($sidebar_id)
    {
        ...
        if (0 == $widget_count % 4 || $widget_count > 6) : // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
                ...
                $widget_classes .= ' col-md-3'; elseif (6 == $widget_count) : // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
                // If two widgets are published.
                $widget_classes .= ' col-md-2'; elseif ($widget_count >= 3) :
                // Three widgets per row if there's three or more widgets.
                $widget_classes .= ' col-md-4'; elseif (2 == $widget_count) : // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
                // If two widgets are published.
                $widget_classes .= ' col-md-6'; elseif (1 == $widget_count) : // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
...
function deprecated_translations()
{
    [
        ...
        __('Next', 'buildystrap'),
        __('About:', 'buildystrap'),
        __('Profile', 'buildystrap'),
        __('Posts by', 'buildystrap'),
