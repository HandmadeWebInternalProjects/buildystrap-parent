  ...
  _createClass(lsExpire, [{
    ...
    value: function isExpired() {
      ...
      if (this.checkStorage()) {
        ...
        var timeStamp = storageItem.timestamp; // Get current time optionally pass a custom date in to compare against that instead

        var pointInTime = new Date().getTime(); // Compare the current time from when it was first timestamped, see if it's been longer than expiry                
    ...
    value: function getStorage() {
      ...
      } else {//   console.log(new Error('there is no local storage item with that name'));
      }
    }
  }, {
    key: "setStorage",
    value: function setStorage() {
      var currentTime = new Date().getTime(); // Save timestamp and optional data to storage
