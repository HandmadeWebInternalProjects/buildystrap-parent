...
/***/ "./resources/js/components/sitewideMessage.js":
/*!****************************************************!*\
  !*** ./resources/js/components/sitewideMessage.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _util_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/storage */ "./resources/js/util/storage.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(el) {
  if (el) {
    var openMessage = function openMessage() {
      messageBar.addEventListener('click', stopProp, {
        once: true
      });
      body.classList.add(visibleClass);
      messageBar.classList.add('is--visible');
      scrollToggle('down');
      messageBarHeight = messageBar === null || messageBar === void 0 ? void 0 : messageBar.clientHeight;
      ...
      exitButton.addEventListener('click', closeMessage, {
        once: true
      });
      messageBar.dispatchEvent(new CustomEvent('hmw_message:opened'));
    };
    var closeMessage = function closeMessage(e) {
    ...
    var visibilityCheck = function visibilityCheck(entries, observer) {
      entries.forEach(function (entry) {
        var headerTop = parseInt(header.style.top) || 0;
    ...
    var scrollToggle = function scrollToggle(direction) {
      messageBar.style.marginTop = "".concat(direction === 'up' ? "-".concat(messageBarHeight, "px") : 0);
    };
    var body = document.body;
    var header = document.querySelector('.main-header');
    var messageBar = el;
    var adminBar = document.getElementById('wpadminbar');
    var links = messageBar.querySelectorAll('a');
    var exitButton = messageBar.querySelector('.bar-exit');
    var storage = new _util_storage__WEBPACK_IMPORTED_MODULE_0__.cookieHelper('sitewide_message', 4);
    var visibleClass = 'message-bar-visible';
    var messageBarHeight = (messageBar === null || messageBar === void 0 ? void 0 : messageBar.clientHeight) || 0;
    var options = {
      root: null,
      rootMargin: '0px',
      threshold: 0
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  var playVimeo = function playVimeo(iframe) {
    if (iframe !== null && iframe !== void 0 && iframe.classList.contains('vimeo-iframe')) {
      var data = {
        method: 'play'
      };
  ...
  videoOverlays.forEach(function (videoOverlay) {
    var playButton = videoOverlay === null || videoOverlay === void 0 ? void 0 : videoOverlay.querySelector('.video-play'),
      parent = playButton === null || playButton === void 0 ? void 0 : playButton.closest('.buildystrap-video-module'),
      iframe = parent === null || parent === void 0 ? void 0 : parent.querySelector('.video-overlay iframe'),
      autoplay = videoOverlay === null || videoOverlay === void 0 ? void 0 : videoOverlay.dataset.autoplay;
...
/* harmony import */ var _components_sitewideMessage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/sitewideMessage */ "./resources/js/components/sitewideMessage.js");
// import './bootstrap';
...
var sitewideMessageEL = document.querySelector('.sitewide-message');
if (sitewideMessageEL) {
  (0,_components_sitewideMessage__WEBPACK_IMPORTED_MODULE_3__["default"])(sitewideMessageEL);
}
...
/* harmony export */   lsExpire: () => (/* binding */ lsExpire)
/* harmony export */ });
...
var lsExpire = /*#__PURE__*/function () {
  function lsExpire(name, hours) {
    _classCallCheck(this, lsExpire);
    this.name = name;
...
var cookieHelper = /*#__PURE__*/function () {
  function cookieHelper(name, hours) {
  ...
  _createClass(cookieHelper, [{
    ...
    value: function setCookie() {
      ...
      if (!this.checkCookie()) {
        document.cookie = "".concat(this.name, "= true; expires= ").concat(date.toGMTString(), ";");
      }
    }
    ...
    value: function checkCookie() {
      ...
      if (document.cookie.split(';').filter(function (item) {
        return item.trim().startsWith("".concat(_this.name, "="));
      }).length) {
        return true;
      }
      return false;
    ...
    value: function clearCookie() {
      if (this.checkCookie()) {
        document.cookie = "".concat(this.name, "= ; expires=Thu, 01 Jan 1970 00:00:00 GMT");
      }
    }
  }]);
  return cookieHelper;
